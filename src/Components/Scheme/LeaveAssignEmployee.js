...
export default function LeaveAssignEmployee() {
  ...
  return (
    <div className="inner_wrapper">
      ...
      <div className="btn_group d-flex justify-content-end pt-3">
        <Link className="btn-secondary mx-3" to="/scheme/leave">
          Cancel
        </Link>
        <Link className="btn-primary" to="/scheme/leave">
          Save
        </Link>
      </div>
    </div>
