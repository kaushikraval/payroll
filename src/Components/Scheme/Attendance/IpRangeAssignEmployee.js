...
export default function IpRangeAssignEmployee() {
  ...
  return (
    <div className="inner_wrapper">
      ...
      <div className="btn_group d-flex justify-content-end pt-3">
        <Link className="btn-secondary mx-3" to="/scheme/attendance/ip-range">
          Cancel
        </Link>
        <Link className="btn-primary" to="/scheme/attendance/ip-range">
          Save
        </Link>
      </div>
    </div>
