...
export default function CaptureMethod() {
          ...
          <div className="row align-items-center">
            ...
            <div className="col-sm-6 order-1 order-sm-2">
              <div className="text-sm-end">
                <Link
                  to="/scheme/attendance/create-capture-method"
        ...
        <div className="data_table_one attendance_track_table">
          <div className="table-responsive employee-code-responsive">
            <table id="example" className="display">
              ...
              <tbody>
                {captureMethodDetail.map((user, index) => {
                  return (
                    <tr key={index}>
                      <td>{user.captureMethod}</td>
                      <td>
                        <Link
                          className="text-secondary"
                          to="/scheme/attendance/capture-method/assign-employee"
                        >
                          <img
                      ...
                      <td>
                        <ul className="edit_wrap d-flex">
                          <li>
                            <Link to="/scheme/attendance/create-capture-method">
                              <img
