...
export default function GeoFancing() {
  ...
  const geoFancingDetail = [
    {
      geoLocationName: 'Mota Varachha Location',
      latitude: '21.2372315',
      longitude: '72.8855627',
      radius: '500',
    ...
    {
      geoLocationName: 'Adajan Location',
      latitude: '21.149241',
      longitude: '72.7866441',
      radius: '1000',
      assignEmployeeIcon: EmployeeIcon,
      actionByName: 'Chintan Raval',
      actionByDate: 'On 20 Nov 2022 • 04:23 PM',
    ...
    {
      geoLocationName: 'Station Location',
      latitude: '21.2047232',
      longitude: '72.8855627',
      radius: '600',
      assignEmployeeIcon: EmployeeIcon,
  ...
  return (
    <div className="inner_wrapper">
      <div className="geo_fen_wrap">
        ...
        <div className="geo_fen__top mb-3">
          <div className="row align-items-center">
            ...
            <div className="col-sm-6 order-1 order-sm-2">
              <div className="text-sm-end">
                <Link
                  to="/scheme/attendance/create-geo-fancing"
        ...
        <div className="data_table_one geo_fen_table">
          <div className="table-responsive employee-code-responsive">
            <table id="example" className="display">
              ...
              <tbody>
                {geoFancingDetail.map((user, index) => {
                  return (
                    <tr key={index}>
                      <td>{user.geoLocationName}</td>
                      <td>{user.latitude}</td>
                      ...
                      <td>
                        <Link
                          ...
                          to="/scheme/attendance/geo-fancing/assign-employee"
                        >
                          <img
                      ...
                      <td>
                        <ul className="edit_wrap d-flex">
                          <li>
                            <Link to="/scheme/attendance/create-geo-fancing">
                              <img
