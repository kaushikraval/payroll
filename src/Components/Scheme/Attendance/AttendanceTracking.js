...
export default function AttendanceTracking() {
  ...
  const attendanceTrackingDetail = [
    {
      attendanceTracking: 'Default',
    ...
    {
      attendanceTracking: 'Manager Group',
      assignEmployeeIcon: EmployeeIcon,
      actionByName: 'Chintan Raval',
      actionByDate: 'On 20 Nov 2022 • 04:23 PM',
      editActionIcon: EditButtonIcon,
    ...
    {
      attendanceTracking: 'Director Group',
      assignEmployeeIcon: EmployeeIcon,
      actionByName: 'Chintan Raval',
      actionByDate: 'On 20 Nov 2022 • 04:23 PM',
      editActionIcon: EditButtonIcon,
  ...
  return (
    <div className="inner_wrapper">
      <div className="attendence_track_wrap">
        ...
        <div className="attendence_track_top mb-3">
          <div className="row align-items-center">
            ...
            <div className="col-sm-6 order-1 order-sm-2">
              <div className="text-sm-end">
                <Link
                  to="/scheme/attendance/create-attendance-tracking"
        ...
        <div className="data_table_one attendance_track_table">
          <div className="table-responsive employee-code-responsive">
            <table id="example" className="display">
              ...
              <tbody>
                {attendanceTrackingDetail.map((user, index) => {
                  return (
                    <tr key={index}>
                      <td>{user.attendanceTracking}</td>
                      <td>
                        <Link
                          className="text-secondary"
                          to="/scheme/attendance/attendance-tracking/assign-employee"
                        >
                          <img
                      ...
                      <td>
                        <ul className="edit_wrap d-flex">
                          <li>
                            <Link to="/scheme/attendance/create-attendance-tracking">
                              <img
