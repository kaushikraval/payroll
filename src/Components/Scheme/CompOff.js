          ...
          <div className="col-sm-6 order-1 order-sm-2">
            <div className="text-sm-end">
              <Link
                ...
                to="/scheme/CompOffStepone/CompOffStepone"
              >
      ...
      <div className="data_table_one letter_temp_table">
        <div className="table-responsive employee-code-responsive">
          <table id="example" className="display">
            ...
            <tbody>
              {compOffDetail.map((user, index) => {
                return (
                  <tr key={index}>
                    <td>{user.coffSchemeName}</td>
                    <td>
                      <Link
                        className="text-secondary"
                        to="/scheme/compoff/assign-employee"
                      >
                        <img
