...
export default function TaxRagime() {
  ...
  const taxRagimeDetail = [
    {
      fYear: '2022 - 2023',
      taxRegime: 'Old Regime',
      slabSchemeApplicableType: 'Male',
    ...
    },
    {
      fYear: '2022 - 2023',
      taxRegime: 'Old Regime',
      slabSchemeApplicableType: 'Female',
      actionByName: 'Chintan Raval',
      actionByDate: 'On 20 Nov 2022 • 04:23 PM',
      editActionLogo: EditButtonIcon,
      deleteActionLogo: DeleteButtonIcon,
    },
    {
      fYear: '2022 - 2023',
      taxRegime: 'Old Regime',
      slabSchemeApplicableType: 'Senior Citizen',
      actionByName: 'Chintan Raval',
      actionByDate: 'On 20 Nov 2022 • 04:23 PM',
      editActionLogo: EditButtonIcon,
      deleteActionLogo: DeleteButtonIcon,
  ...
  return (
    <div className="inner_wrapper">
      ...
      <div className="tax_config_wrap">
        <div className="tax_config_top mb-3">
          <div className="row align-items-center">
            ...
            <div className="col-sm-6 order-1 order-sm-2">
              <div className="text-sm-end">
                <Link
                  to="/statutory/itconfiguration/create-tax-regime"
        ...
        <div className="data_table_one tax_config_table">
            ...
            <table id="example" className="display">
              <thead>
                <tr>
                  ...
                  <th>
                    <span>Slab Scheme Applicable Type</span>
                  </th>
                  <th>
                    <span>Action By</span>
                  </th>
              ...
              <tbody>
                {taxRagimeDetail.map((user, index) => {
                  return (
                    <tr key={index}>
                      <td>{user.fYear}</td>
                      <td>{user.taxRegime}</td>
                      <td>{user.slabSchemeApplicableType}</td>
                      <td>
                      ...
                      <td>
                        <ul className="edit_wrap d-flex">
                          <li>
                            <Link to="/statutory/itconfiguration/create-tax-regime">
                              <img
