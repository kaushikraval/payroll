...
export default function PfConfiguration() {
  ...
  const pfConfigurationDetail = [
    {
      pfGroupName: 'Restrict to 15000 of PF Wages',
      date: '1 Apr 2021',
    ...
    {
      pfGroupName: '12% of Actual PF Wages',
      date: '1 Apr 2021',
      deductionType: 'Monthly',
      actionByName: 'Chintan Raval',
      actionByDate: 'On 20 Nov 2022 • 04:23 PM',
    ...
    <div className="inner_wrapper">
      <div className="breadcrumbs">
        <ul>
          ...
          <li>PF Configuration</li>
        </ul>
      </div>
      <div className="pf_configuration_wrap">
        <div className="pf_config_top mb-3">
          <div className="row align-items-center">
            ...
            <div className="col-sm-6 order-1 order-sm-2">
              <div className="text-sm-end">
                <Link
                  to="/statutory/pfconfiguration/create-pfconfiguration"
        ...
        <div className="data_table_one pf_configuration_table">
          <div className="table-responsive employee-code-responsive">
            <table id="example" className="display">
              <thead>
                <tr>
                  <th>
                    <span>PF Group Name</span>
                  </th>
                  <th>
                    <span>Date</span>
                  </th>
              ...
              <tbody>
                {pfConfigurationDetail.map((user, index) => {
                  return (
                    <tr key={index}>
                      <td>{user.pfGroupName}</td>
                      <td>{user.date}</td>
                      ...
                      <td>
                        <ul className="edit_wrap d-flex">
                          <li>
                            <Link to="/statutory/pfconfiguration/create-pfconfiguration">
                              <img
