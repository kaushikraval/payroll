...
export default function EsicConfiguration() {
  ...
  const esicConfigurationDetail = [
    {
      esicGroupName: 'Default',
    ...
    {
      esicGroupName: 'Contractor Employee',
      effectiveMonth: '1 Apr 2019',
      deductionType: 'Monthly',
      actionByName: 'Chintan Raval',
      actionByDate: 'On 20 Nov 2022 • 04:23 PM',
    ...
    <div className="inner_wrapper">
      <div className="breadcrumbs">
        <ul>
          ...
          <li>ESIC Configuration </li>
        </ul>
      </div>
      <div className="esic_Config_wrap">
        <div className="esic_Config_top mb-3">
          <div className="row align-items-center">
            ...
            <div className="col-sm-6 order-1 order-sm-2">
              <div className="text-sm-end">
                <Link
                  to="/statutory/esicconfiguration/create-esicconfiguration"
        ...
        <div className="data_table_one esic_Config_table">
          <div className="table-responsive employee-code-responsive">
            <table id="example" className="display">
              <thead>
                <tr>
                  <th>
                    <span>ESIC Group Name</span>
                  </th>
                  <th>
              ...
              <tbody>
                {esicConfigurationDetail.map((user, index) => {
                  return (
                    <tr key={index}>
                      <td>{user.esicGroupName}</td>
                      ...
                      <td>
                        <ul className="edit_wrap d-flex">
                          <li>
                            <Link to="/statutory/esicconfiguration/create-esicconfiguration">
                              <img
                          ...
                          <li onClick={() => setDeleteDetail(true)}>
                            <img src={user.deleteActionLogo} alt="delete_btn" />
                          </li>
                        </ul>
                      </td>
                    </tr>
