    ...
    <div className="inner_wrapper">
      <div className="breadcrumbs">
        <ul>
          ...
          <li>PT Configuration </li>
        </ul>
      </div>
      <div className="pt_Config_wrap">
        <div className="pt_Config_top mb-3">
          <div className="row align-items-center">
            ...
            <div className="col-sm-6 order-1 order-sm-2">
              <div className="text-sm-end">
                <Link
                  to="/statutory/create-ptconfiguration"
        ...
        <div className="data_table_one pt_Config_table">
          <div className="table-responsive employee-code-responsive">
            <table id="example" className="display">
              ...
              <tbody>
                {ptConfigurationDetail.map((user, index) => {
                  return (
                    <tr key={index}>
                      <td>{user.state}</td>
                      ...
                      <td>
                        <ul className="edit_wrap d-flex">
                          <li>
                            <Link to="/statutory/create-ptconfiguration">
                              <img
