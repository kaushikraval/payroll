...
export default function Compensation() {
  ...
  const compensation = [
    {
      ...
      location: 'Station',
      paymentType: 'Bank',
      ctcSalary: 'Salary setup Pending',
    },
    {
      empCode: '1002',
      empProfile: EmployeeImg,
  ...
  const handleTrClick = () => {
    navigate('/payroll/view-compensation-details');
  };
  return (
    <>
      ...
      <div className="data_table_one compansation_table">
              ...
              {compensation?.map(data => {
                return (
                  <tr>
                    ...
                    <td>
                      {data.ctcSalary === 'Salary setup Pending' ? (
                        <Link
                          to="/payroll/salary-setup"
                          className="salary_setup d-inline-block"
                        >
                          {data.ctcSalary}
                        </Link>
                      ) : (
