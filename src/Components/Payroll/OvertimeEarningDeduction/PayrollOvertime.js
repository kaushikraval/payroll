    ...
    <>
      ...
      <div className="row align-items-center mb-3">
        ...
        <div className="col-sm-8 order-1 order-sm-2">
          <div className="text-end d-flex align-items-center justify-content-sm-end mt-2 mt-sm-0">
            <button type="button" className="btn-border">
              <img className="me-2" src={Export} /> Export
            </button>
            <Link to="/payroll/process-payroll" className="btn-secondary mx-2">
              Back
            </Link>
            <Link to="/payroll/process-payroll/earning" className="btn-primary">
              Save & Continue
            </Link>
          </div>
        </div>
