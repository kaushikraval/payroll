...
export default function ViewCompensationDetails() {
  ...
  return (
    <>
      ...
      <div className="salary_user d-flex justify-content-between">
      ...
      <div className="compansation_wrap border-top">
                    ...
                    <div className="salary_template_wrap mb-3">
                      <div className="row">
                          ...
                          <div className="row">
                            <div className="col-md-4">
                              <div className="form_group">
                                <label>
                                  {t('compensation.salary_template')}
                                </label>
                                <Input
                                  type="text"
                                  value={t(
                            ...
                            <div className="col-md-4">
                              <div className="d-flex align-items-center right_padding">
                                <div className="form_group">
                                  <label>
                                    {t('compensation.annual_ctc_amount')}
                                  </label>
                                  <Input
                                    type="text"
                                    value={t(
                                      'insuarance_detail.sum_insured_value',
                                    )}
                                  />
                                </div>
                                <div className="right_label">
                                  <p className="m-0">
                                    {t('compensation.per_year')}
                                  </p>
                                </div>
                              </div>
                            </div>
                        ...
                        <div className="col-xl-3 col-12 text-end">
                          <Link
                            to="/payroll/compensation-edit"
                            class="btn-border me-2 mb-2"
                          >
                            Edit
                          </Link>
                          <Link
                            to="/payroll/compensation-salary-revision"
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <span className="badge bedge_success ms-2">
                                <img src={UpGraphArrow} alt="UpGraphArrow" />{' '}
                                20%
                              </span>
                            </td>
                            <td>
