      ...
      <div className="add_earning_deducation_form">
        ...
        <div className="mb-3 d-flex">
          ...
          <label htmlFor="WebDevlopment" className="p-checkbox-label ms-2">
            Is Component part of employee’s salary structure
          </label>
        </div>
        <div className="mb-3 d-flex">
          <Checkbox
        ...
        <div className="mb-3 d-flex">
          ...
          ></Checkbox>
          <label htmlFor="WebDevlopment" className="p-checkbox-label ms-2">
            Consider this component in PF contribution
          </label>
        </div>
        <div className="mb-3 d-flex">
          <Checkbox
          ...
          ></Checkbox>
          <label htmlFor="WebDevlopment" className="p-checkbox-label ms-2">
            Consider this component in ESI contribution
          </label>
        </div>
        <div className="mb-3 d-flex">
          <Checkbox
          ...
          ></Checkbox>
          <label htmlFor="WebDevlopment" className="p-checkbox-label ms-2">
            Consider this component in for OT Payment calculation
          </label>
        </div>
        <div className="mb-3 d-flex">
          <Checkbox
