...
export default function ApplyLeave() {
  const [toingredient, setToIngredient] = useState('');
                ...
                <div className="form_group">
                  <div className="d-flex flex-wrap gap-3">
                    <div className="d-flex align-items-center">
                      <RadioButton
                        inputId="fromfirsthalf"
                        name="pizza"
                        value="FromFirstHalf"
                        onChange={e => setFromIngredient(e.value)}
                        checked={fromingredient === 'FromFirstHalf'}
                      />
                      <label htmlFor="fromfirsthalf" className="mb-0">
                        First Half
                      </label>
                    </div>
                    <div className="d-flex align-items-center">
                      <RadioButton
                        inputId="fromrosecondhalf"
                        name="pizza"
                        value="FromSecondHalf"
                        onChange={e => setFromIngredient(e.value)}
                        checked={fromingredient === 'FromSecondHalf'}
                      />
                      <label htmlFor="fromrosecondhalf" className="mb-0">
                        Second Half
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="d-flex flex-wrap gap-3">
                    <div className="d-flex align-items-center">
                      <RadioButton
                        ...
                        name="pizza"
                        value="ToFirstHalf"
                        onChange={e => setToIngredient(e.value)}
                        checked={toingredient === 'ToFirstHalf'}
                      />
                      <label htmlFor="tofirsthalf" className="mb-0">
                        First Half
                      </label>
                    </div>
                    <div className="d-flex align-items-center">
                      <RadioButton
                        inputId="torosecondhalf"
                        name="pizza"
                        value="ToSecondHalf"
                        onChange={e => setToIngredient(e.value)}
                        checked={toingredient === 'ToSecondHalf'}
                      />
                      <label htmlFor="torosecondhalf" className="mb-0">
                        Second Half
                      </label>
                    </div>
                  </div>
