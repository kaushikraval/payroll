...
export default function ReimbursementApproval() {
  ...
  const reimbursementApprovalData = [
    {
      ...
      <div className="data_table_one expense_table">
        <div className="table-responsive">
          <table id="example" className="display">
            ...
            <tbody>
              {reimbursementApprovalData.map((data, i) => {
                return (
                  <tr>
                    <td>
                      <Link to="/expense-reimbursement/expense-trip/reimbursement-request">
