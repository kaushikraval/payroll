...
import ExportRight from '../../../Assets/images/export-right.svg';
  ...
  return (
    <div className="inner_wrapper">
      ...
      <div className="data_table_one employee_exit_table">
        ...
        <div className="employee_exit_table_inner">
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        <div className="created_date">
                          <span className="text_green">{emp.exitType}</span>
                          <span>{emp.exitReason}</span>
                        </div>
                      </td>
                      <td>
                          ...
                          {emp.editAction === true && (
                            <li>
                              <Button
                                ...
                                className="tooltip_button"
                                onClick={() => onClick('editExitEmp')}
                              >
                                <img src={Edit} alt="edit" />
                              </Button>
                            </li>
                          )}
                          {emp.cancelRequest === true && (
                            <li>
                              <Button
                                tooltip="Cancel Exit Request"
                                tooltipOptions={{
                                  position: 'bottom',
                                }}
                                className="tooltip_button"
                              ...
                              >
                                <img src={ExportRight} alt="export" />
                              </Button>
                            </li>
                          )}
                        </ul>
      ...
      <Dialog
        header="Edit Exit Employee"
        visible={editExitEmp}
        draggable={false}
        resizable={false}
        className="medium_popup"
        footer={renderFooter('editExitEmp')}
        onHide={() => onHide('editExitEmp')}
      >
        <div className="row">
          <div className="col-md-6">
            <div className="form_group">
      ...
      <Dialog
        header="View Exit Employee"
        visible={viewExitEmp}
        draggable={false}
        resizable={false}
        className="medium_popup"
        footer={renderFooter('viewExitEmp')}
        onHide={() => onHide('viewExitEmp')}
      >
        <div className="row">
          <div className="col-md-6">
            <div className="form_group">
      ...
      >
        <div className="cancel_ext_request">
          <p className="text-center">
            Are you sure you want to cancel the exit request?
          </p>
          <div className="form_group">
            <label>Description</label>
            <TextArea placeholder="Write Description" rows={5} cols={10} />
